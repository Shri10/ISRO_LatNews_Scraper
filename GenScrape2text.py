...
with open('isro_elements.csv', 'w', newline='', encoding='utf-8') as csvfile:
    fieldnames = ['Tag', 'Class', 'Text']
    ...
    for element in elements_with_classes:
        ...
        writer.writerow({'Tag': tag_name, 'Class': class_names, 'Text': text_content})
